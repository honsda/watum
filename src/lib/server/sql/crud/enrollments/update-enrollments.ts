...
export async function updateEnrollments(connection: Connection, data: UpdateEnrollmentsData, params: UpdateEnrollmentsParams): Promise<UpdateEnrollmentsResult> {
    ...
    return connection.query(sql, [data.id !== undefined, data.id, data.student_id !== undefined, data.student_id, data.course_id !== undefined, data.course_id, data.class_room_id !== undefined, data.class_room_id, data.schedule_id !== undefined, data.schedule_id, data.semester !== undefined, data.semester, data.academic_year !== undefined, data.academic_year, data.status !== undefined, data.status, data.created_at !== undefined, data.created_at, data.updated_at !== undefined, data.updated_at, params.id])
