	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				destructive:
					'border-destructive/30 bg-destructive/12 text-foreground hover:bg-destructive/18 focus-visible:border-destructive/45 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/22 dark:hover:bg-destructive/30 [&_svg]:text-destructive',
