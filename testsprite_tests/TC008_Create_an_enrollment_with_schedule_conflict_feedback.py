...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email (index 8) and password (index 9) fields with admin credentials, then click the submit button (index 10) to sign in.
        ...
        # -> Click the 'KRS' (Enrollments) menu item to open the enrollments page and reveal the enrollment form.
        # button "KRS"
