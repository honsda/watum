...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and submit the login form to sign in as admin@watum.local.
        ...
        # -> Click the 'Refresh' button (element [371]) to trigger session refresh, then verify the authenticated dashboard remains visible.
        # button "Refresh"
