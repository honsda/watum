...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email and password fields and click the 'Masuk' submit button to attempt login.
        ...
        # -> Click the 'Ruang Kelas' navigation item (index 275) to open the classroom management area and verify the classroom list is displayed.
        # button "Ruang Kelas"
