...
async def run_test():
    ...
    try:
        ...
        # -> Fill the email with an invalid (but syntactically valid) address and password, submit the form, and then check for an authentication error while the login card remains visible.
