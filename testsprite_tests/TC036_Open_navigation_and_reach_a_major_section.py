...
async def run_test():
    ...
    try:
        ...
        # -> Enter admin credentials into the email and password fields and submit the login form to reach the authenticated shell.
        ...
        # -> Click the 'Mata Kuliah' navigation item (index 339) to navigate to that section and then verify the page content and section-specific actions are shown.
        # button "Mata Kuliah"
